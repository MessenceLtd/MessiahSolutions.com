...
namespace MessenceComFrontEnd
{
    public class WebsiteOperationsTools
    {
        ...
        public static void SendContactUsEmailDetails(
            string fromUrl, string fullName, string emailAddress, string phone, string message)
        {
            ...
            emailTemplateKeyValues.Add("phone", phone);
            emailTemplateKeyValues.Add("description", message.Replace(Environment.NewLine, "<br/>"));
