...
$document.ready(function () {
	 ...
	 */
	if (plugins.copyright.length) {
		plugins.copyright.text(initialDate.getFullYear());
	}
...
$(document).ready(function () {
	...
	if ($("#MailLayoutContactUsForm").length > 0)
	{

		$("#MailLayoutContactUsForm").submit(function (e) {
			e.preventDefault();
	...
	if ($("#MainContactUsForm").length > 0) {

		$("#MainContactUsForm").submit(function (e) {
			e.preventDefault();
